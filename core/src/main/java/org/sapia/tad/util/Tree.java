...
public class Tree<K, V> {
  ...
  public static class Node<K, V> {
    ...
    public Node(NoArgFunction<Map<K, Node<K, V>>> mapFunc) {
      this.level = 0;
  ...
  /**
   * @param path a {@link Collection} of path segments, corresponding to a hierarchical path.
