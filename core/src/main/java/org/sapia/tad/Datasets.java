...
import org.sapia.tad.help.Hide;
...
public class Datasets {
   ...
   */
  @Hide
  public static Dataset dataset(ColumnSet columns, Value[][] arraysOfVectorValues) {
    return new DefaultDataset(columns, RowSets.rowSet(arraysOfVectorValues));
  }
  
  /**
   * @param columns a {@link ColumnSet}
   * @param rows a {@link List} of {@link Vector} instances to use as rows.
   * @return a new {@link Dataset}.
   */
  @Hide
